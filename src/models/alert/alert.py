import uuid
import requests
import models.alert.constants as AlertConstants
import datetime
...
class Alert:
    ...
    def send(self):
        b= requests.post(AlertConstants.URL,auth=("api",AlertConstants.API_KEY),data={
    ...
    def find_needing_update(cls,minutes_since_update=10):
        last_updated_limit = datetime.datetime.utcnow() - datetime.timedelta(minutes=AlertConstants.ALERT_TIMEOUT)
